<template>
    ...
    <div class="container">
    	<div class="row justify-content-center">
        	...
        	<div class="col-md-10">
            	<div class="card">
                	<div class="card-header">Configuración > Catalogo</div>
					<div class="card-body">
                        <div class="container">
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-hover table-striped" id="example">
                                        ...
                                        <tbody>
                                            <tr v-for="producto in catalogo" :key="producto.id">
                                                ...
                                                <td v-if="rol === 'ADMINISTRADOR'"><button class="btn btn-danger" v-on:click.prevent="deleteCatalogo(producto)">Eliminar</button></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <nav>
